    ...
    <div class="content-wrapper">
        ...
        <div class="card shadow mb-4 content">
            <div class="card-header py-3 row">
                <div class="col-md-9">
                <h6 class="m-0 font-weight-bold text-primary">Estoque de material presentes na seção de informática</h6>&nbsp &nbsp
                </div>
                <div class="col-md-3">
                ...
                <a href="?p=estoque-usado" class="btn btn-success btn-sm mr-2" style="float:right;">
                    Estoque usado
                </a>
                &nbsp &nbsp
                <a href="?p=estoque-disponivel" class="btn btn-warning btn-sm mr-2" style="float:right;">
                    Estoque disponível
                </a>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <?php
                            $listar = $objEstoque->listarEstoque();
                            $count = 1; //contador 
                            foreach ($listar as $linha) {
                            ?>
                                
                                <tr <?php if($linha->usado == 1) { ?> onclick="location.href='?p=chamados&estoque=usado&cd=<?= $linha->id_estoque; ?>'"  <?php } else {} ?> class="<?= ($linha->usado == 1 ? 'bg-gradient-info' : '')?>" style="cursor: pointer; text-align: center;color:<?= $linha->usado == 1 ? 'white' : '' ?>">
                                    <td><?= $count; ?></td>
                                    <td>
                                        <?= $linha->material; ?>
                                        <br>
                                    ...
                                    <td>
                                        ...
                                        <?php }else { 
                                            echo '<i>Usado</i> <br>
                                        <small><i>Ticket: #'.$linha->ticket;'.</i></small>';} ?>
                                    </td>
                                </tr>
