    ...
    <div class="content-wrapper">
        ...
        <div class="card shadow mb-4 content">
            <div class="card-header py-3 row">
                <h6 class="m-0 font-weight-bold text-primary">Estoque disponível</h6>&nbsp &nbsp
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <?php
                            $listar = $objEstoque->listarEstoqueDisponivel();
                            $count = 1; //contador 
                            foreach ($listar as $linha) {
                            ?>
                                <tr class="<?= ($linha->usado == 1 ? 'bg-gradient-info' : '')?>" style="text-align: center;color:<?= $linha->usado == 1 ? 'white' : '' ?>">
                                    <td><?= $count; ?></td>
                                    <td>
                                        <?= $linha->material; ?>
                                        <br>
